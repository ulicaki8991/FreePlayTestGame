...
if ( TRACE ) { TRACE( "CameraFollow#Start", this ); }
                ...
                if (UnityEngine.Component.op_Equality(this.target, null)) {
                    ...
                    if (UnityEngine.GameObject.op_Inequality(player, null)) {
...
if ( TRACE ) { TRACE( "CameraFollow#FixedUpdate", this ); }
                ...
                var desiredPosition = this.target.position.$clone().add( this.offset );

                if (this.tracking) {
                    // Smoothly move the camera towards the desired position
                    this.transform.position = pc.Vec3.smoothDamp( this.transform.position.$clone(), desiredPosition.$clone(), Bridge.ref(this, "velocity"), 1.0 / this.smoothSpeed, Infinity, UnityEngine.Time.deltaTime );
                } else {
                    this.transform.position = pc.Vec3.smoothDamp( this.transform.position.$clone(), this.EndTarget.$clone(), Bridge.ref(this, "velocity"), 1.0 / this.smoothSpeed, Infinity, UnityEngine.Time.deltaTime );
                }
            },
...
if ( TRACE ) { TRACE( "DG.Tweening.DOTweenModuleUtils.Physics#CreateDOTweenPathTween", this ); }
    ...
    /*EndForce start.*/
    Bridge.define("EndForce", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            force: 0
        },
        methods: {
            /*EndForce.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "EndForce#Start", this ); }


            },
            /*EndForce.Start end.*/

            /*EndForce.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "EndForce#Update", this ); }


            },
            /*EndForce.Update end.*/

            /*EndForce.OnTriggerEnter start.*/
            OnTriggerEnter: function (other) {
if ( TRACE ) { TRACE( "EndForce#OnTriggerEnter", this ); }

                if (other.gameObject.CompareTag("Player")) {
                    var playerRb = other.gameObject.GetComponent(UnityEngine.Rigidbody);
                    playerRb.AddForce$1(playerRb.velocity.$clone().scale( -1 ).clone().scale( this.force ), UnityEngine.ForceMode.Impulse);
                }
            },
            /*EndForce.OnTriggerEnter end.*/
    ...
    /*EndTrigger start.*/
    Bridge.define("EndTrigger", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            gm: null
        },
        methods: {
            /*EndTrigger.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "EndTrigger#Start", this ); }


            },
            /*EndTrigger.Start end.*/

            /*EndTrigger.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "EndTrigger#Update", this ); }


            },
            /*EndTrigger.Update end.*/

            /*EndTrigger.OnTriggerEnter start.*/
            OnTriggerEnter: function (other) {
if ( TRACE ) { TRACE( "EndTrigger#OnTriggerEnter", this ); }

                if (other.gameObject.CompareTag("Player")) {
                    this.gm.Die(other.gameObject);
                }
            },
            /*EndTrigger.OnTriggerEnter end.*/
...
if ( TRACE ) { TRACE( "GM#Update", this ); }
                ...
                if (UnityEngine.Input.GetMouseButtonDown(0)) {
                    ...
                    if (this.TutorialActive) {
                        this.TutorialSlider.SetActive(false);
                        $t = Bridge.getEnumerator(this.RegSlider);
                        try {
                            while ($t.moveNext()) {
                                var img = $t.Current;
                                DG.Tweening.DOTweenModuleUI.DOFade$2(img, 1, 0.01);
                            }
                        } finally {
            ...
            /*GM.Ratio start.*/
            Ratio: function () {
if ( TRACE ) { TRACE( "GM#Ratio", this ); }

                if (UnityEngine.Screen.height > UnityEngine.Screen.width) {
                    this.mainCamera.orthographicSize = this.camSizeVer;
                } else {
                    this.mainCamera.orthographicSize = this.camSizeHor;
                }
            },
            /*GM.Ratio end.*/
            ...
            /*GM.InGameCTA start.*/
            InGameCTA: function () {
if ( TRACE ) { TRACE( "GM#InGameCTA", this ); }
            ...
            /*GM.InstalGame start.*/
            InstalGame: function () {
if ( TRACE ) { TRACE( "GM#InstalGame", this ); }
            ...
            /*GM.Die start.*/
            Die: function (player) {
if ( TRACE ) { TRACE( "GM#Die", this ); }

                var $t;
                this.audioSource.PlayOneShot(this.brakeSound);
                DG.Tweening.DOTweenModuleAudio.DOFade(this.propellerAudio, 0, 0.4);
                player.GetComponent(Player).controllSound = false;
                $t = Bridge.getEnumerator(this.objectsOfPlayer);
                try {
                    while ($t.moveNext()) {
                        var obj = $t.Current;
                        obj.transform.SetParent(null);
                        obj.AddComponent(UnityEngine.Rigidbody);
                    }
                } finally {
                    if (Bridge.is($t, System.IDisposable)) {
                        $t.System$IDisposable$Dispose();
                ...
                UnityEngine.Object.Destroy(this.Player.GetComponent(UnityEngine.Rigidbody));
                UnityEngine.Object.Destroy(this.Player.GetComponent(UnityEngine.CapsuleCollider));
                UnityEngine.MonoBehaviour.Destroy(this.Player);
                this.cameraFollow.tracking = false;
                this.cameraFollow.EndTarget = player.transform.position.$clone();

                Luna.Unity.LifeCycle.GameEnded();
                this.StartCoroutine$1(this.FadeOut());
            },
            /*GM.Die end.*/

            /*GM.FadeOut start.*/
            FadeOut: function () {
if ( TRACE ) { TRACE( "GM#FadeOut", this ); }
                            ...
                            switch ($step) {
                                ...
                                case 1: {
                                    this.audioSource.PlayOneShot(this.failSound);
                                        this.EndGame = true;
                                        $t = Bridge.getEnumerator(this.HiddingImages);
                                        try {
                                            while ($t.moveNext()) {
                                                img = $t.Current;
                                                DG.Tweening.DOTweenModuleUI.DOFade$2(img, 0, 0.3);
                                            }
                                        } finally {
                                            if (Bridge.is($t, System.IDisposable)) {
                                                $t.System$IDisposable$Dispose();
...
if ( TRACE ) { TRACE( "Player#init", this ); }
                ...
                this.controllSound = true;
            }
        },
        methods: {
            /*Player.CheckForWind start.*/
            CheckForWind: function () {
if ( TRACE ) { TRACE( "Player#CheckForWind", this ); }

                if (this.power > 0.5) {
                    UnityEngine.Debug.Log$1("Wind Particle System Play");
                    this.windParticleSystem.Play();
                } else {
                    UnityEngine.Debug.Log$1("Wind Particle System Stop");
                    this.windParticleSystem.Stop();
                }

            },
            /*Player.CheckForWind end.*/

            /*Player.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "Player#Update", this ); }

                this.power = this.powerSlider.value;
                if (this.controllSound) {
                    this.propellerAudio.volume = this.power / 2;
                }


                // Apply force continuously based on power value
                this.ApplyPowerForce();
            ...
            /*Player.ApplyPowerForce start.*/
            ApplyPowerForce: function () {
if ( TRACE ) { TRACE( "Player#ApplyPowerForce", this ); }

                UnityEngine.Debug.Log$1("Speed: " + System.Single.format(this.rb.velocity.length()));
                if (UnityEngine.Component.op_Inequality(this.rb, null) && this.isGrounded) {
                    // Apply force in object's local right direction based on power and speed
                    var forceDirection = this.transform.right.$clone(); // Local +X axis
                    var forceAmount = this.power * this.speed;
                    this.rb.AddForce$1(forceDirection.$clone().clone().scale( forceAmount ).clone().scale( this.rb.mass ), UnityEngine.ForceMode.Force);
            ...
            /*Player.ApplyPowerForce end.*/

            /*Player.RotateWheels start.*/
            RotateWheels: function () {
if ( TRACE ) { TRACE( "Player#RotateWheels", this ); }

                var $t;
                if (this.wheels != null && UnityEngine.Component.op_Inequality(this.rb, null)) {
                    // Calculate rotation speed based on current velocity
                    var currentSpeed = this.rb.velocity.length();
                    var rotationSpeed = currentSpeed * 60.0; // Adjust multiplier as needed

                    // Rotate each wheel in the array
                    var rotationAxis = pc.Vec3.DOWN.clone(); // X-axis
                    $t = Bridge.getEnumerator(this.wheels);
                    try {
                        while ($t.moveNext()) {
                            var wheel = $t.Current;
                            if (UnityEngine.Component.op_Inequality(wheel, null)) {
                                wheel.Rotate$2(rotationAxis.$clone().clone().scale( rotationSpeed ).clone().scale( UnityEngine.Time.deltaTime ));
                            }
                        }
                    } finally {
                        if (Bridge.is($t, System.IDisposable)) {
            ...
            /*Player.RotateWheels end.*/

            /*Player.RotatePropeller start.*/
            RotatePropeller: function () {
if ( TRACE ) { TRACE( "Player#RotatePropeller", this ); }

                if (UnityEngine.Component.op_Inequality(this.propeller, null)) {
                    // Calculate propeller rotation speed based on power value
                    var propellerRotationSpeed = this.power * 1500.0; // Adjust multiplier as needed

                    // Rotate propeller around X-axis
                    var rotationAxis = pc.Vec3.RIGHT.clone(); // X-axis
                    this.propeller.Rotate$2(rotationAxis.$clone().clone().scale( propellerRotationSpeed ).clone().scale( UnityEngine.Time.deltaTime ));
                }
            },
            /*Player.RotatePropeller end.*/

            /*Player.OnCollisionEnter start.*/
            OnCollisionEnter: function (collision) {
if ( TRACE ) { TRACE( "Player#OnCollisionEnter", this ); }

                // Check if colliding object is not a child of this player
                if (!this.IsChildOfPlayer(collision.transform)) {
                    this.isGrounded = true;
                }
            },
            /*Player.OnCollisionEnter end.*/

            /*Player.OnCollisionStay start.*/
            OnCollisionStay: function (collision) {
if ( TRACE ) { TRACE( "Player#OnCollisionStay", this ); }
            ...
            /*Player.OnCollisionStay end.*/

            /*Player.OnCollisionExit start.*/
            OnCollisionExit: function (collision) {
if ( TRACE ) { TRACE( "Player#OnCollisionExit", this ); }
            ...
            /*Player.OnCollisionExit end.*/

            /*Player.IsChildOfPlayer start.*/
            IsChildOfPlayer: function (other) {
if ( TRACE ) { TRACE( "Player#IsChildOfPlayer", this ); }

                // Check if the other transform is a child of this player
                var parent = other.parent;
                while (UnityEngine.Component.op_Inequality(parent, null)) {
                    if (UnityEngine.Component.op_Equality(parent, this.transform)) {
                        return true;
                    }
    ...
    Bridge.define("RoadBlock", {
        ...
        methods: {
            /*RoadBlock.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "RoadBlock#Start", this ); }

                this.rb = this.GetComponent(UnityEngine.Rigidbody);
            },
            /*RoadBlock.Start end.*/

            /*RoadBlock.OnCollisionEnter start.*/
            OnCollisionEnter: function (collision) {
if ( TRACE ) { TRACE( "RoadBlock#OnCollisionEnter", this ); }

                if (collision.gameObject.CompareTag("Player") && !this.triggered) {
                    this.triggered = true;
                    this.StartCoroutine$1(this.Fall());
                }
            },
            /*RoadBlock.OnCollisionEnter end.*/

            /*RoadBlock.Fall start.*/
            Fall: function () {
if ( TRACE ) { TRACE( "RoadBlock#Fall", this ); }
                ...
                var $enumerator = new Bridge.GeneratorEnumerator(Bridge.fn.bind(this, function () {
                    try {
                        for (;;) {
                            switch ($step) {
                                case 0: {
                                    $enumerator.current = new UnityEngine.WaitForSeconds(this.waitingTime);
                                        $step = 1;
                                        return true;
                                }
                                case 1: {
                                    this.triggered = true;
                                        ...
                                        DG.Tweening.DOVirtual.Float(4, 0, this.fallTime, Bridge.fn.bind(this, function (x) {
                                            this.rb.drag = x;
                                        }));
                                        this.audioSource.PlayOneShot(this.breakSound);
    ...
    Bridge.define("SimpleOutline", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "SimpleOutline#init", this ); }

                this.outlineColor = new UnityEngine.Color();
                this.outlineColor = new pc.Color( 0, 0, 0, 1 );
                this.scaleFactor = 1.05;
            }
        },
        methods: {
            /*SimpleOutline.OnEnable start.*/
            OnEnable: function () {
if ( TRACE ) { TRACE( "SimpleOutline#OnEnable", this ); }

                this.Build();
            },
            /*SimpleOutline.OnEnable end.*/

            /*SimpleOutline.OnValidate start.*/
            OnValidate: function () {
if ( TRACE ) { TRACE( "SimpleOutline#OnValidate", this ); }

                this.Build();
            },
            /*SimpleOutline.OnValidate end.*/

            /*SimpleOutline.OnDisable start.*/
            OnDisable: function () {
if ( TRACE ) { TRACE( "SimpleOutline#OnDisable", this ); }

                this.Clear();
            },
            /*SimpleOutline.OnDisable end.*/

            /*SimpleOutline.Clear start.*/
            Clear: function () {
if ( TRACE ) { TRACE( "SimpleOutline#Clear", this ); }

                if (!UnityEngine.Object.op_Implicit(this.outlineGO)) {
                    return;
                }
                UnityEngine.MonoBehaviour.Destroy(this.outlineGO);
            },
            /*SimpleOutline.Clear end.*/

            /*SimpleOutline.Build start.*/
            Build: function () {
if ( TRACE ) { TRACE( "SimpleOutline#Build", this ); }

                this.Clear();

                var mf = this.GetComponent(UnityEngine.MeshFilter);
                if (UnityEngine.Component.op_Equality(mf, null) || mf.sharedMesh == null) {
                    return;
                }

                /* 1 — spawn invisible child */
                this.outlineGO = new UnityEngine.GameObject.$ctor2("Outline");
                this.outlineGO.hideFlags = UnityEngine.HideFlags.HideAndDontSave;
                this.outlineGO.transform.SetParent(this.transform, false);
                this.outlineGO.transform.localScale = new pc.Vec3( 1, 1, 1 ).clone().scale( this.scaleFactor );

                /* 2 — share the mesh */
                this.outlineGO.AddComponent(UnityEngine.MeshFilter).sharedMesh = mf.sharedMesh;

                /* 3 — simple Unlit/Color material with front-face culling */
                var mr = this.outlineGO.AddComponent(UnityEngine.MeshRenderer);
                var mat = this.outlineMaterial != null ? this.outlineMaterial : new UnityEngine.Material.$ctor2(UnityEngine.Shader.Find("Unlit/Color"));
                mat.color = this.outlineColor.$clone();
                mat.renderQueue = 2001;

                // 0 = Off, 1 = Back, 2 = Front
                if (mat.HasProperty$1("_Cull")) {
                    mat.SetInt$1("_Cull", 2);
                }

                mr.sharedMaterial = mat;
            },
            /*SimpleOutline.Build end.*/
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","UnityEngine","System.Collections","UnityEngine.UI","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];

    /*CameraFollow start.*/
    $m("CameraFollow", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"FixedUpdate","t":8,"sn":"FixedUpdate","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":2,"n":"EndTarget","t":4,"rt":$n[1].Vector3,"sn":"EndTarget"},{"a":2,"n":"offset","t":4,"rt":$n[1].Vector3,"sn":"offset"},{"a":2,"n":"smoothSpeed","t":4,"rt":$n[0].Single,"sn":"smoothSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"target","t":4,"rt":$n[1].Transform,"sn":"target"},{"at":[new UnityEngine.HeaderAttribute("Follow Settings"),new UnityEngine.SerializeFieldAttribute()],"a":2,"n":"tracking","t":4,"rt":$n[0].Boolean,"sn":"tracking","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"velocity","t":4,"rt":$n[1].Vector3,"sn":"velocity"}]}; }, $n);
    /*CameraFollow end.*/

    /*EndForce start.*/
    $m("EndForce", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnTriggerEnter","t":8,"pi":[{"n":"other","pt":$n[1].Collider,"ps":0}],"sn":"OnTriggerEnter","rt":$n[0].Void,"p":[$n[1].Collider]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"force","t":4,"rt":$n[0].Single,"sn":"force","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*EndForce end.*/

    /*EndTrigger start.*/
    $m("EndTrigger", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"OnTriggerEnter","t":8,"pi":[{"n":"other","pt":$n[1].Collider,"ps":0}],"sn":"OnTriggerEnter","rt":$n[0].Void,"p":[$n[1].Collider]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"gm","t":4,"rt":GM,"sn":"gm"}]}; }, $n);
    /*EndTrigger end.*/

    /*GM start.*/
    $m("GM", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Die","t":8,"pi":[{"n":"player","pt":$n[1].GameObject,"ps":0}],"sn":"Die","rt":$n[0].Void,"p":[$n[1].GameObject]},{"a":1,"n":"FadeOut","t":8,"sn":"FadeOut","rt":$n[2].IEnumerator},{"a":2,"n":"InGameCTA","t":8,"sn":"InGameCTA","rt":$n[0].Void},{"a":2,"n":"InstalGame","t":8,"sn":"InstalGame","rt":$n[0].Void},{"a":1,"n":"Ratio","t":8,"sn":"Ratio","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"CTA","t":4,"rt":$n[1].GameObject,"sn":"CTA"},{"a":2,"n":"EndGame","t":4,"rt":$n[0].Boolean,"sn":"EndGame","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"Fader","t":4,"rt":$n[1].GameObject,"sn":"Fader"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"Fail","t":4,"rt":$n[1].GameObject,"sn":"Fail"},{"at":[new UnityEngine.HeaderAttribute("UI"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"HiddingImages","t":4,"rt":System.Array.type(UnityEngine.UI.Image),"sn":"HiddingImages"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"Player","t":4,"rt":$n[1].GameObject,"sn":"Player"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"RegSlider","t":4,"rt":System.Array.type(UnityEngine.UI.Image),"sn":"RegSlider"},{"a":1,"n":"TutorialActive","t":4,"rt":$n[0].Boolean,"sn":"TutorialActive","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HeaderAttribute("Tutorial"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"TutorialSlider","t":4,"rt":$n[1].GameObject,"sn":"TutorialSlider"},{"at":[new UnityEngine.HeaderAttribute("Audio"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"audioSource","t":4,"rt":$n[1].AudioSource,"sn":"audioSource"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"brakeSound","t":4,"rt":$n[1].AudioClip,"sn":"brakeSound"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"camSizeHor","t":4,"rt":$n[0].Single,"sn":"camSizeHor","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"camSizeVer","t":4,"rt":$n[0].Single,"sn":"camSizeVer","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"cameraFollow","t":4,"rt":CameraFollow,"sn":"cameraFollow"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"failSound","t":4,"rt":$n[1].AudioClip,"sn":"failSound"},{"at":[new UnityEngine.HeaderAttribute("ratio"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"mainCamera","t":4,"rt":$n[1].Camera,"sn":"mainCamera"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"objectsOfPlayer","t":4,"rt":System.Array.type(UnityEngine.GameObject),"sn":"objectsOfPlayer"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"propellerAudio","t":4,"rt":$n[1].AudioSource,"sn":"propellerAudio"}]}; }, $n);
    /*GM end.*/

    /*Player start.*/
    $m("Player", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"ApplyPowerForce","t":8,"sn":"ApplyPowerForce","rt":$n[0].Void},{"a":2,"n":"CheckForWind","t":8,"sn":"CheckForWind","rt":$n[0].Void},{"a":1,"n":"IsChildOfPlayer","t":8,"pi":[{"n":"other","pt":$n[1].Transform,"ps":0}],"sn":"IsChildOfPlayer","rt":$n[0].Boolean,"p":[$n[1].Transform],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"OnCollisionEnter","t":8,"pi":[{"n":"collision","pt":$n[1].Collision,"ps":0}],"sn":"OnCollisionEnter","rt":$n[0].Void,"p":[$n[1].Collision]},{"a":1,"n":"OnCollisionExit","t":8,"pi":[{"n":"collision","pt":$n[1].Collision,"ps":0}],"sn":"OnCollisionExit","rt":$n[0].Void,"p":[$n[1].Collision]},{"a":1,"n":"OnCollisionStay","t":8,"pi":[{"n":"collision","pt":$n[1].Collision,"ps":0}],"sn":"OnCollisionStay","rt":$n[0].Void,"p":[$n[1].Collision]},{"a":1,"n":"RotatePropeller","t":8,"sn":"RotatePropeller","rt":$n[0].Void},{"a":1,"n":"RotateWheels","t":8,"sn":"RotateWheels","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"at":[new UnityEngine.HeaderAttribute("Audio")],"a":2,"n":"controllSound","t":4,"rt":$n[0].Boolean,"sn":"controllSound","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"isGrounded","t":4,"rt":$n[0].Boolean,"sn":"isGrounded","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"maxSpeed","t":4,"rt":$n[0].Single,"sn":"maxSpeed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"power","t":4,"rt":$n[0].Single,"sn":"power","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"powerSlider","t":4,"rt":$n[3].Slider,"sn":"powerSlider"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"propeller","t":4,"rt":$n[1].Transform,"sn":"propeller"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"propellerAudio","t":4,"rt":$n[1].AudioSource,"sn":"propellerAudio"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"rb","t":4,"rt":$n[1].Rigidbody,"sn":"rb"},{"at":[new UnityEngine.LunaPlaygroundFieldAttribute("Speed", -1, null, false, null),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"speed","t":4,"rt":$n[0].Single,"sn":"speed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"wheels","t":4,"rt":System.Array.type(UnityEngine.Transform),"sn":"wheels"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"windParticleSystem","t":4,"rt":$n[1].ParticleSystem,"sn":"windParticleSystem"}]}; }, $n);
    /*Player end.*/

    /*RoadBlock start.*/
    $m("RoadBlock", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Fall","t":8,"sn":"Fall","rt":$n[2].IEnumerator},{"a":1,"n":"OnCollisionEnter","t":8,"pi":[{"n":"collision","pt":$n[1].Collision,"ps":0}],"sn":"OnCollisionEnter","rt":$n[0].Void,"p":[$n[1].Collision]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"audioSource","t":4,"rt":$n[1].AudioSource,"sn":"audioSource"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"breakSound","t":4,"rt":$n[1].AudioClip,"sn":"breakSound"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"fallTime","t":4,"rt":$n[0].Single,"sn":"fallTime","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"rb","t":4,"rt":$n[1].Rigidbody,"sn":"rb"},{"a":1,"n":"triggered","t":4,"rt":$n[0].Boolean,"sn":"triggered","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"waitingTime","t":4,"rt":$n[0].Single,"sn":"waitingTime","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*RoadBlock end.*/

    /*SimpleOutline start.*/
    $m("SimpleOutline", function () { return {"att":1048577,"a":2,"at":[new UnityEngine.RequireComponent.$ctor1(UnityEngine.MeshFilter, UnityEngine.MeshRenderer)],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Build","t":8,"sn":"Build","rt":$n[0].Void},{"a":1,"n":"Clear","t":8,"sn":"Clear","rt":$n[0].Void},{"a":1,"n":"OnDisable","t":8,"sn":"OnDisable","rt":$n[0].Void},{"a":1,"n":"OnEnable","t":8,"sn":"OnEnable","rt":$n[0].Void},{"a":1,"n":"OnValidate","t":8,"sn":"OnValidate","rt":$n[0].Void},{"at":[new UnityEngine.ColorUsageAttribute.ctor(false)],"a":2,"n":"outlineColor","t":4,"rt":$n[1].Color,"sn":"outlineColor"},{"a":1,"n":"outlineGO","t":4,"rt":$n[1].GameObject,"sn":"outlineGO"},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"outlineMaterial","t":4,"rt":$n[1].Material,"sn":"outlineMaterial"},{"at":[new UnityEngine.TooltipAttribute("Scale factor > 1 grows the duplicate mesh.\n1.05 = +5 % \u2248 3-5 px on most ads."),new UnityEngine.RangeAttribute(1.0, 1.2)],"a":2,"n":"scaleFactor","t":4,"rt":$n[0].Single,"sn":"scaleFactor","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*SimpleOutline end.*/
    ...
    /*DG.Tweening.DOTweenModulePhysics2D start.*/
    $m("DG.Tweening.DOTweenModulePhysics2D", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOJump","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJump","rt":$n[6].Sequence,"p":[$n[1].Rigidbody2D,$n[1].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"path","pt":$n[7].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[6].PathMode,"ps":3}],"sn":"DOLocalPath$1","rt":$n[5].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody2D,$n[7].Path,$n[0].Single,$n[6].PathMode]},{"a":2,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector2),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[6].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[6].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOLocalPath","rt":$n[5].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody2D,System.Array.type(UnityEngine.Vector2),$n[0].Single,$n[6].PathType,$n[6].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DOMove","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMove","rt":$n[5].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].Rigidbody2D,$n[1].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveX","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveX","rt":$n[5].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].Rigidbody2D,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveY","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveY","rt":$n[5].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].Rigidbody2D,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"path","pt":$n[7].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[6].PathMode,"ps":3}],"sn":"DOPath$1","rt":$n[5].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody2D,$n[7].Path,$n[0].Single,$n[6].PathMode]},{"a":2,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector2),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[6].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[6].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOPath","rt":$n[5].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody2D,System.Array.type(UnityEngine.Vector2),$n[0].Single,$n[6].PathType,$n[6].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DORotate","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DORotate","rt":$n[5].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[1].Rigidbody2D,$n[0].Single,$n[0].Single]}]}; }, $n);
    /*DG.Tweening.DOTweenModulePhysics2D end.*/
